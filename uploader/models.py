...
#        globals()[name] = models.FloatField()
#    for name in string_names:
#        globals()[name] = models.CharField(max_length=20)
#    for name in logical_names:
#        globals()[name] = models.BooleanField()
    # Jun: leave array and varray at the moment
    # pretty messy, can organize into different databases by different types of calculations
