    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('date_updated', models.DateTimeField(auto_now=True, auto_now_add=True)),
                ('country', models.ForeignKey(blank=True, to='authsys.Country', null=True)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            model_name='city',
            name='state',
            field=models.ForeignKey(blank=True, to='authsys.State', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='user',
            name='city',
            field=models.ForeignKey(blank=True, to='authsys.City', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='user',
